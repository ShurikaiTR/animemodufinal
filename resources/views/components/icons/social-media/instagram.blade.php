<svg {{ $attributes }} id="Instagram" width="24" height="24" viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg">
    <g id="Iconly/Light/Instagram" stroke="none" stroke-width="1.5" fill="none" fill-rule="evenodd" stroke-linecap="round"
        stroke-linejoin="round">
        <g id="Instagram" stroke="currentColor" stroke-width="1.5">
            <path
