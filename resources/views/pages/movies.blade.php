...
<div class="mx-auto w-full max-w-7xl">
    @include('pages.movies.partials.header-controls')

    @include('pages.movies.partials.filter-bar')

    @if($this->isAlphabeticalSort())
        @include('pages.movies.partials.alpha-filter-bar')
    @endif

    @include('pages.movies.partials.results')
</div>
